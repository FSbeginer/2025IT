...
{
    public partial class Control마이페이지 : UserControl
    {
        public Control마이페이지()
        {
            InitializeComponent();
        ...
        private void Control마이페이지_Load(object sender, EventArgs e)
        {
        ...
        {
            (FindForm() as BF).showPage(new View.Form소개서추가());
        }

        private void pictureBox3_Click(object sender, EventArgs e)
        {
            (FindForm() as BF).showPage(new View.Form댓글확인());
        }
    }
}
