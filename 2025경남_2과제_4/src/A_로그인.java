...
public class A_로그인 extends BF {
	...
	public A_로그인() {
		...
		label.setBounds(12, 10, 457, 51);
		getContentPane().add(label);
		
		textField = new PlaceHolder("ID");
		textField.setBounds(12, 71, 222, 32);
		getContentPane().add(textField);
		textField.setColumns(10);
		
		textField_1 = new PlaceHolder("PW");
		textField_1.setColumns(10);
		textField_1.setBounds(246, 71, 222, 32);
		getContentPane().add(textField_1);
		
		button = new JButton("\uB85C\uADF8\uC778");
		button.addActionListener(new ButtonActionListener());
		button.setBounds(12, 113, 457, 32);
