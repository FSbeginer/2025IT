...
public class F_커뮤니티 extends BP {
	...
	public F_커뮤니티() {
		...
		label.setBounds(926, 10, 60, 60);
		panel.add(label);

		scrollPane = new JScrollPane();
		scrollPane.setBounds(23, 109, 943, 387);
		...
		label_1.setBounds(936, 70, 47, 15);
		panel.add(label_1);
		...
		label_2.setBounds(8, 3, 132, 58);
		panel_1.add(label_2);

		label_3 = new JLabel("New label");
		label_3.setFont(new Font("맑은 고딕", Font.BOLD, 15));
		label_3.setBounds(31, 71, 383, 58);
		panel_1.add(label_3);
		...
		textArea.setBounds(31, 138, 405, 345);
		panel_1.add(textArea);

		label_4 = new JLabel("New label");
		label_4.setForeground(Color.GRAY);
		label_4.setHorizontalAlignment(SwingConstants.RIGHT);
		label_4.setBounds(231, 493, 206, 23);
		panel_1.add(label_4);

		scrollPane_1 = new JScrollPane();
		scrollPane_1.setBounds(481, 138, 458, 345);
		...
		textField.setBounds(478, 494, 367, 21);
		...
		label_5.setBounds(857, 493, 45, 45);
		panel_1.add(label_5);
		
		button = new JButton("\uC0AD\uC81C\uD558\uAE30");
		button.addActionListener(new ButtonActionListener());
		button.setBackground(Color.RED);
		button.setBounds(31, 493, 97, 23);
		panel_1.add(button);
