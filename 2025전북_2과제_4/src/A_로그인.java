...
public class A_로그인 extends BF {
	...
	public A_로그인() {
		...
		textField.setBounds(100, 70, 265, 27);
		getContentPane().add(textField);
		textField.setColumns(10);

		textField_1 = new JTextField();
		textField_1.addKeyListener(new TextField_1KeyListener());
		textField_1.setBorder(new MatteBorder(0, 0, 1, 0, (Color) new Color(155, 208, 232)));
		textField_1.setColumns(10);
		textField_1.setBounds(100, 120, 265, 27);
